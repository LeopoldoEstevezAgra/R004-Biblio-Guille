...
const InfoLibro = () => {
    ...
    return (
        <div className={styles.body}>
            <Link href="/">
                <button className={styles.botonVolver}>&lt;&lt;</button>
            </Link>
            ...
            <div className={styles.sectionContainer}>
                ...
                <div className={styles.recomendados}>
                    {recoms &&
                        recoms.length &&
                        recoms.map((book: bookType, index) => {
                            return (
                                <TarjetaLibroMini
                                    key={index}
                                    book={book}
            ...
            <div className={styles.sectionContainer}>
                ...
                <div>
                    {resenhas &&
                        resenhas.length &&
                        resenhas.map((resenha: resenhaType, index) => {
                            return (
                                <TarjetaResenha key={index} resenha={resenha} />
                            );
                        })}
                </div>
            </div>
